...
You have context of the littlefactory change system. Use it naturally, don't force it.
...
- Their names and what the user might be working on
...
1. **Read existing artifacts for context**
   - `.littlefactory/changes/<name>/proposal.md`
   - `.littlefactory/changes/<name>/design.md`
   - `.littlefactory/changes/<name>/tasks.json`
   - etc.
...
3. **Offer to capture when decisions are made**
   ...
   | New work identified | `tasks.json` |
...
- **Don't implement** - Never write code or implement features. Creating change artifacts is fine, writing application code is not.
