...
The system SHALL serialize metadata to JSON at tasks/run_metadata.json.

#### Scenario: Metadata save after each iteration
- **WHEN** Each iteration completes
- **THEN** System writes updated RunMetadata to tasks/run_metadata.json with proper ISO8601 timestamps
