...
**Reason**: Replaced by configurable agent that can run any command including claude.
**Migration**: Configure claude in agents map: `claude: { command: "claude --dangerously-skip-permissions --print" }`

### Requirement: Session path computation
**Reason**: Session ID management removed to simplify interface.
**Migration**: Session management deferred; agents maintain their own context as needed.
