...
## What It Does
Environment variable configuration for agents, supporting static values and dynamic shell-evaluated values. Variables are set on the agent process at startup, with shell commands evaluated inline and failures treated as fatal.
