...
## What It Does
Factoryfile is a YAML configuration file that defines agent settings, iteration limits, timeouts, and directory paths. It is required for the run command and supports named agent entries with a designated default agent.
