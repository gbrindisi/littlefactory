...
## What It Does
During init, the system ensures that littlefactory runtime files (run_metadata.json, tasks.json) are listed in .gitignore. Updates are idempotent, the file is created if missing, and existing content is preserved.
