...
## What It Does
The driver iteration loop claims tasks, executes agents, and updates task status based on outcomes. It supports change-based task sources and worktree workspaces, managing the full lifecycle of task execution from claim through completion or failure.
