...
## What It Does
Manages the progress.md log file that records iteration history across runs. The file is append-only, accumulating session logs chronologically so that agents and operators can review what has been done.
