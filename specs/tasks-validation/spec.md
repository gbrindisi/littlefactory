...
## What It Does
Validates the structure and content of tasks.json files on load, checking JSON syntax, required fields, status values, ID uniqueness, and sequential blocker chain integrity. Reports all errors at once rather than failing on the first issue.
